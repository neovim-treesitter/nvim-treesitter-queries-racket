# nvim-treesitter-queries-racket

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-racket/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-racket/actions/workflows/validate.yml)

Neovim tree-sitter queries for **racket**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-racket",
...
- [ ] Changes are scoped to `racket` — do not include files for other languages
